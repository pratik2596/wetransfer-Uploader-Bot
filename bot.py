...
######################################################################################
bot_token ='875777594:AAHUD8W-eBag8MK-UJawVa-8DOaHeJK67DE'       #
...
def help(update, context):
    context.bot.send_message(chat_id=update.message.chat_id, text="I am in Beta. Mod by @isumitbot",parse_mode=telegram.ParseMode.HTML)
